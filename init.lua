...
-- Don't close Neotree when toggling back and forth
vim.keymap.set('n', '<leader>fe', ':Neotree focus<CR>', { desc = 'Focus Neo-tree' })
...
require('lazy').setup({
  -- auto complete brackets
  {
    ...
    event = 'InsertEnter',
    opts = {
      check_ts = true, -- nicer behavior with Treesitter
      fast_wrap = {},
    },
  },
